...
import 'package:shot_alert/Screens/contacts.dart';
import 'package:shot_alert/Screens/profile.dart';
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Logger.logUserAction(
                          "Home tab selected on navigation bar");
                    },
                  ),
                  IconButton(
                    icon: Icon(
                    ...
                    onPressed: () {
                      Logger.logUserAction(
                          "Contacts tab selected on navigation bar");
                      Get.to(Contacts(userId: user!.uid));
                    },
                  ),
                  IconButton(
                    onPressed: () {
                      Logger.logUserAction(
                          "Profile tab selected on navigation bar");
                      Get.to(() => Profile());
                    },
                    icon: Icon(
                      Icons.person,
...
// import 'make_emergency_call.dart';

// void triggerFullEmergency(String phoneNumber) {
//   EmergencyAlert().triggerEmergency(phoneNumber); // Siren, SMS, Torch
//   makeEmergencyCall(phoneNumber); // Call the emergency contact
// }
